      ...
      <v-form>
        ...
        <v-card flat>
          ...
          <crud-table
            componente="telefone"
            titulo="Telefone"
            :headers="cabecalhoTelefone"
            :propItens="telefonesCadastradosCliente"
            editavel
            deletavel
          >
        ...
        <v-card flat>
          ...
          <crud-table
            componente="endereco"
            titulo="Endereço"
            :headers="cabecalhoEndereco"
            :propItens="enderecosCadastradosCliente"
          >
            <template v-slot:formAdd>
              <endereco></endereco>
            </template>
...
export default {
  ...
  created() {
    ...
    this.cliente.telefones.push(
      this.$store.getters["cliente/getTelefonesCliente"]
    );
